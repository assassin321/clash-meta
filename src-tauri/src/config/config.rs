use super::{IClashTemp, IProfiles, IMeta};
use crate::{
...
impl Config {
        ...
        CONFIG
            .get_or_init(|| async {
                Self {
                    ...
                    verge_config: Draft::new(IMeta::new().await),
    ...
    pub async fn verge() -> Draft<IMeta> {
    ...
    pub async fn generate_file(typ: ConfigType) -> Result<PathBuf> {
        ...
        help::save_yaml(&path, config, Some("# Generated by Clash Meta")).await?;
        Ok(path)
    }
