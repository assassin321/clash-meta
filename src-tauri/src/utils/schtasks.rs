...
const TASK_NAME_USER: &str = "Clash Meta";
const TASK_NAME_ADMIN: &str = "Clash Meta (Admin)";
const TASK_XML_DIR: &str = "tasks";
const TASK_XML_USER: &str = "clash-meta-task-user.xml";
const TASK_XML_ADMIN: &str = "clash-meta-task-admin.xml";
...
async fn cleanup_legacy_shortcuts() -> Result<()> {
    ...
    let old_shortcut = startup_dir.join("Clash-Meta.lnk");
    let new_shortcut = startup_dir.join("Clash Meta.lnk");
