...
// 本地存储的键名
const STORAGE_KEY_GROUP = 'clash-meta-selected-proxy-group'
const STORAGE_KEY_PROXY = 'clash-meta-selected-proxy'
const STORAGE_KEY_SORT_TYPE = 'clash-meta-proxy-sort-type'
