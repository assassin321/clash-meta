...
**Applies to:** the Clash Meta desktop application for Windows, macOS and
Linux, distributed from
<https://github.com/assassin321/clash-meta/releases>.

**Last updated:** 2026-09-09

Clash Meta is a free and open-source graphical client for the
...
The Clash Meta maintainers, reachable through the project's issue tracker
at <https://github.com/assassin321/clash-meta/issues>. Because the
...
| Platform | Location |
| --- | --- |
| Windows | `%APPDATA%\io.github.assassin321.clash-meta` |
| macOS | `~/Library/Application Support/io.github.assassin321.clash-meta` |
| Linux | `$XDG_DATA_HOME/io.github.assassin321.clash-meta` (usually `~/.local/share/…`) |

It contains:

- `meta.yaml` — application settings. If you configure WebDAV backup, the
...
supplied, sending a `User-Agent` of `clash-meta/v<version>` unless you set a
...
the DNS configuration and `meta.yaml`; **WebDAV credentials are stripped from
`meta.yaml` before upload, but proxy servers, passwords and subscription URLs
...
Open an issue at
<https://github.com/assassin321/clash-meta/issues>. Please do not
