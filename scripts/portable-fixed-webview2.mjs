...
async function resolvePortable() {
  ...
  zip.addLocalFile(path.join(releaseDir, 'clash-mihomo.exe'))
  zip.addLocalFile(path.join(releaseDir, 'clash-mihomo-alpha.exe'))
  ...
  const zipFile = `Clash.Meta_${version}_${arch}_fixed_webview2_portable.zip`
